...
public class HappyGhastHarnessAdaptModel extends EntityModel<HappyGhastRenderState> {

    public static final EntityModelLayer LAYER_LOCATION = new EntityModelLayer(Identifier.of(IWantItEarlier.MOD_ID, "happy_ghast_harness_adapt"), "main");
    private final ModelPart bone;
    private final ModelPart goggles;

    public HappyGhastHarnessAdaptModel(ModelPart modelPart) {
        super(modelPart);

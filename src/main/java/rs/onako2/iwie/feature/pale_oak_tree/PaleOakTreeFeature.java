...
public class PaleOakTreeFeature extends Feature<PaleOakTreeFeatureConfig> {
    public PaleOakTreeFeature(Codec<PaleOakTreeFeatureConfig> configCodec) {
        super(configCodec);
    }
    ...
    @Override
    public boolean generate(FeatureContext<PaleOakTreeFeatureConfig> context) {
        ...
        PaleOakTreeFeatureConfig config = context.getConfig();

package rs.onako2.feature.pale_moss_feature;
...
public class PaleMossPatchFeature extends Feature<PaleMossPatchConfig> {
    public PaleMossPatchFeature(Codec<PaleMossPatchConfig> configCodec) {
        super(configCodec);
    }

    @Override
    public boolean generate(FeatureContext<PaleMossPatchConfig> context) {
        ...
        PaleMossPatchConfig config = context.getConfig();

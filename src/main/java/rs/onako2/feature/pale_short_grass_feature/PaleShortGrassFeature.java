package rs.onako2.feature.pale_short_grass_feature;
...
public class PaleShortGrassFeature extends Feature<PaleShortGrassPatchConfig> {
    ...
    public boolean generate(FeatureContext<PaleShortGrassPatchConfig> context) {
        ...
        PaleShortGrassPatchConfig config = context.getConfig();
